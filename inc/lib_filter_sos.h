...
float filter_iir_dir_form2_process_one_section(filter_sos_dir_form2_t *pFilter, float input);
float filter_iir_dir_form2_process_combined_sections(filter_sos_dir_form2_t *pFilter, float input, unsigned int nrSections);
